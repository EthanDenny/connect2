  ...
  useEffect(() => {
    ...
    const GetPosts = async (count: number) => {
      const edgesData = await fetch(
        "https://f77b-2607-fea8-d5c3-7d80-9d0-c0e4-deda-8c8f.ngrok-free.app/api/collections/edges/records?perPage=100",
        {
          headers: {
      ...
      let nodeIds = await fetch(
        "https://f77b-2607-fea8-d5c3-7d80-9d0-c0e4-deda-8c8f.ngrok-free.app/api/collections/posts/records?sort=@random&perPage=" +
          count,
        {
          headers: {
            "Content-Type": "application/json",
